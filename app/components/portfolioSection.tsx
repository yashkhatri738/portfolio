...
const projects = [
  ...
  },
  {
    ...
    github: "https://github.com/yashkhatri738/YouTube_Clone/tree/main/YouTube_clone",
  ...
  },
  {
    ...
    github: "https://github.com/yashkhatri738/Netflix-React/tree/main/netflix_react",
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hovered ? `0 20px 60px ${project.color}25, 0 0 0 1px ${project.color}30` : "none",
      ...
      <div style={{ position: "relative", overflow: "hidden", aspectRatio: "16/9" }}>
        ...
        <div style={{
          ...
          <a
            ...
            onMouseLeave={e => { e.currentTarget.style.background = "rgba(0,0,0,0.8)"; e.currentTarget.style.transform = "scale(1)"; }}
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="white"><path d="M12 2C6.477 2 2 6.477 2 12c0 4.42 2.865 8.17 6.839 9.49.5.092.682-.217.682-.482 0-.237-.008-.866-.013-1.7-2.782.603-3.369-1.342-3.369-1.342-.454-1.155-1.11-1.462-1.11-1.462-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.578 9.578 0 0 1 12 6.836c.85.004 1.705.114 2.504.336 1.909-1.294 2.747-1.025 2.747-1.025.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.578.688.48C19.138 20.167 22 16.418 22 12c0-5.523-4.477-10-10-10z"/></svg>
          </a>
          <a
            href={project.live}
            target="_blank"
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
          </a>
        </div>
      </div>
      ...
      <div style={{ padding: "18px 20px 20px" }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: "8px" }}>
            ...
            >
              <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.477 2 2 6.477 2 12c0 4.42 2.865 8.17 6.839 9.49.5.092.682-.217.682-.482 0-.237-.008-.866-.013-1.7-2.782.603-3.369-1.342-3.369-1.342-.454-1.155-1.11-1.462-1.11-1.462-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.578 9.578 0 0 1 12 6.836c.85.004 1.705.114 2.504.336 1.909-1.294 2.747-1.025 2.747-1.025.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.578.688.48C19.138 20.167 22 16.418 22 12c0-5.523-4.477-10-10-10z"/></svg>
              Code
            </a>
          ...
          <div style={{
            ...
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke={project.color} strokeWidth="2.5"><line x1="7" y1="17" x2="17" y2="7"/><polyline points="7 7 17 7 17 17"/></svg>
          </div>
        </div>
      </div>
...
export default function PortfolioSection({ activeSection }) {
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 32px", position: "relative" }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ width: 6, height: 6, borderRadius: "50%", background: "#a78bfa", animation: "blink 2s infinite" }} />
              <span style={{ fontSize: "11px", color: "#a78bfa", fontFamily: "'Outfit', sans-serif", letterSpacing: "0.12em", textTransform: "uppercase" }}>My Work</span>
            </div>
            ...
            <p style={{
              ...
              A collection of projects built with modern web technologies — from UI clones to full-stack apps.
            </p>
              ...
              {filters.map(f => (
                <button
                  ...
                  style={{
                    ...
                    background: activeFilter === f ? "rgba(167,139,250,0.12)" : "transparent",
