...
//   const parallaxSlow = `translateY(${scrollY * 0.3}px)`;
//   const parallaxMed = `translateY(${scrollY * 0.5}px)`;
//   const parallaxFast = `translateY(${scrollY * 0.7}px)`;
//   const tilt3D = `perspective(1000px) rotateX(${mousePos.y * -6}deg) rotateY(${mousePos.x * 6}deg) translateZ(0)`;
...
//       <header
//         ref={sectionRef}
//         className={`section sec1 header ${activeSection === "home" ? "active" : ""}`}
//         id="home"
//         style={{
//           position: "relative",
//           width: "100%",
...
//         {/* Large background name — PARALLAX */}
//         <div style={{
//           position: "absolute",
//           top: "50%", left: "50%",
...
//             zIndex: 10,
//           }}>
//             <div style={{ fontSize: "10px", color: "rgba(255,255,255,0.4)", fontFamily: "'Outfit', sans-serif", marginBottom: "2px" }}>Status</div>
...
//               <span style={{ fontSize: "12px", color: "#e8ff47", fontFamily: "'Outfit', sans-serif", fontWeight: 500 }}>Available</span>
//             </div>
//           </div>
...
//             zIndex: 10,
//           }}>
//             <div style={{ fontSize: "10px", color: "rgba(255,255,255,0.4)", fontFamily: "'Outfit', sans-serif", marginBottom: "2px" }}>Company</div>
//             <div style={{ fontSize: "12px", color: "#60a5fa", fontFamily: "'Outfit', sans-serif", fontWeight: 500 }}>PrimexMeta 🚀</div>
//           </div>
...
//             whiteSpace: "nowrap",
//           }}>
//             <div style={{ fontSize: "12px", color: "#a78bfa", fontFamily: "'Outfit', sans-serif", fontWeight: 500, textAlign: "center" }}>
//               Fullstack Developer
//             </div>
//           </div>
//         </div>
...
//               marginBottom: "16px",
//             }}>
//               <span style={{ fontSize: "11px", color: "#e8ff47", fontFamily: "'Outfit', sans-serif", letterSpacing: "0.1em", textTransform: "uppercase" }}>Portfolio 2025</span>
//             </div>
...
//               <span style={{
//                 color: "#e8ff47",
//                 textShadow: "0 0 40px rgba(232,255,71,0.4)",
//               }}>Yash.</span>
//             </h1>
...
//               paddingLeft: "14px",
//             }}>
//               BCA Final Year · Building complete web apps from DB to UI. 6 months at{" "}
...
//                 transition: "all 0.2s",
//                 boxShadow: "0 0 30px rgba(232,255,71,0.25)",
//               }}
//               onMouseEnter={e => { e.currentTarget.style.transform = "scale(1.04)"; e.currentTarget.style.boxShadow = "0 0 50px rgba(232,255,71,0.45)"; }}
//               onMouseLeave={e => { e.currentTarget.style.transform = "scale(1)"; e.currentTarget.style.boxShadow = "0 0 30px rgba(232,255,71,0.25)"; }}
//             >
...
//         {/* === 3D FLOATING CARDS — bottom corners === */}
//         {/* Card 1 — bottom left */}
//         <div
//           ref={cardRef}
//           style={{
...
//             opacity: mounted ? 1 : 0,
//             transform: mounted
//               ? `perspective(600px) rotateX(${mousePos.y * -8}deg) rotateY(${mousePos.x * 8}deg) translateY(0)`
//               : "translateY(40px)",
...
//         }}>
//           <span style={{ fontSize: "10px", color: "rgba(255,255,255,0.25)", fontFamily: "'Outfit'", letterSpacing: "0.15em", textTransform: "uppercase" }}>Scroll</span>
//           <div style={{
...
//             #home .left-text { top: 12% !important; left: 5% !important; transform: none !important; }
//             #home .right-text { top: auto !important; bottom: 15% !important; right: 5% !important; transform: none !important; max-width: 90% !important; left: 5% !important; }
//           }
//         `}</style>
//       </header>
//     </>
